...
% Gratting
%epi{1}(125:150,55:95)= c_eps_0*11.3;
%epi{1}(95:120,55:95)= c_eps_0*11.3;
%epi{1}(65:90,55:95)= c_eps_0*11.3;

% Unique Shape
epi{1}(120:140,25:35)= c_eps_0*11.3;
epi{1}(120:140,40:50)= c_eps_0*11.3;
epi{1}(120:140,55:65)= c_eps_0*11.3;
epi{1}(120:140,70:80)= c_eps_0*11.3;
epi{1}(120:140,85:95)= c_eps_0*11.3;
epi{1}(120:140,100:110)= c_eps_0*11.3;
epi{3}(120:140,1:25)= c_eps_0*11.3;
...
bc{1}.s(3).paras = {mag*4,phi,omega,betap,t0,st,s,y0,sty,'s'};
